...
export default function SettingsPage() {
  ...
  const openDialog = (method: "crypto" | "mobile") => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        >
          ...
          <CardContent className="text-sm text-muted-foreground space-y-1">
            <div>
              <strong>Address:</strong> {cryptoAddress}
            </div>
            <div>
              <strong>Blockchain:</strong> {cryptoBlockchain}
            </div>
            <div>
              <strong>Coin:</strong> {cryptoCoin}
            </div>
            <div>
        ...
        >
          ...
          <CardContent className="text-sm text-muted-foreground space-y-1">
            <div>
              <strong>Number:</strong> {mobileMoneyNumber}
            </div>
            <div>
              <strong>Payee Name:</strong> {payeeName}
            </div>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={setCryptoBlockchain}
                  >
