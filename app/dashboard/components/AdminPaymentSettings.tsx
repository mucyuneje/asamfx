...
export default function AdminPaymentSettings() {
  ...
  const [activeMethod, setActiveMethod] = useState<"MOBILE_MONEY" | "CRYPTO">(
    "MOBILE_MONEY"
  );
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <h2 className="text-3xl font-bold">Admin Payment Settings</h2>
      ...
      {/* Show Both Accounts Side by Side as Bank Cards */}
