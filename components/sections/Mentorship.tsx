...
const mentorshipPlans = [
  {
    name: "Basic",
    price: "$99 / month",
    features: ["Weekly group calls", "Access to trading chat", "Email support"],
  },
  {
    name: "Pro",
    price: "$199 / month",
    features: ["2x weekly group calls", "Priority chat support", "Trading resources"],
  },
  {
    name: "Premium",
    price: "$399 / month",
    features: ["1-on-1 mentorship", "Daily market analysis", "VIP community access"],
  },
];

export default function Mentorship() {
  return (
    <section id="mentorship" className="w-full py-16 px-4 bg-background text-foreground">
